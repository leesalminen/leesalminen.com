...
right now — pubkeys instead of usernames, signed events, simple
relays. About as much of "the open web" as you can fit in 100 lines
of code.

Run it: `run projects/nostr-feed/demo`
